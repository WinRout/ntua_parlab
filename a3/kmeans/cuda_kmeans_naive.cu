						...
						int blockSize)
{
    ...
    const unsigned int numClusterBlocks = /* TODO: Calculate Grid size, e.g. number of blocks. */
    (numObjs + numThreadsPerClusterBlock - 1) / numThreadsPerClusterBlock; 
    /* done */
    const unsigned int clusterBlockSharedDataSize = 0; // numThreadsPerClusterBlock * sizeof(unsigned char);//[it was 0 initially]
	...
	fprintf(fp, "%s,%d,%lf,%lf,%lf,%lf,%lf,%lf\n", "Naive", blockSize, timing/loop, timer_min, timer_max, time_cpu, time_gpu, time_transfers);
	fclose(fp); 
