...
##rm kmeans_omp_reduction_conf1.out
rm kemans_omp_reduction_conf2.out
##rm kmeans_omp_reduction_fs_conf1.out
##rm kmeans_omp_reduction_fs_conf2.out
for i in 1 2 4 8 16 32 64
do
    export OMP_NUM_THREADS=$i
    export GOMP_CPU_AFFINITY=0-$i
    ##./kmeans_omp_naive -s 256 -n 16 -c 16 -l 10 >> kmeans_omp_naive_affinity.out
    ##./kmeans_omp_reduction -s 256 -n 16 -c 16 -l 10 >> kmeans_omp_reduction_conf1.out
    ./kmeans_omp_reduction -s 256 -n 1 -c 4 -l 10 >> kmeans_omp_reduction_conf2.out
    ##./kmeans_omp_reduction_fs -s 256 -n 16 -c 16 -l 10 >> kmeans_omp_reduction_fs_conf1.out
    ##./kmeans_omp_reduction_fs -s 256 -n 1 -c 4 -l 10 >> kmeans_omp_reduction_fs_conf2.out
done
